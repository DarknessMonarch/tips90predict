      ...
      <div className={styles.authWrapper}>
        <form onSubmit={handleSubmit} className={styles.formContainer}>
          ...
          <div className={styles.authInput}>
            <UserNameIcon height={20} alt="username icon"  className={styles.authIcon} />
            <input
              type="text"
              name="username"
          ...
          {/* Email */}
          <div className={styles.authInput}>
            <EmailIcon height={20} alt="email icon" className={styles.authIcon} />
            <input
              type="email"
              name="email"
          ...
          {/* Country Dropdown */}
          <div className={styles.authInput}>
            <CountryIcon height={20}  alt="country icon" className={styles.authIcon} />
          ...
          {/* Phone Number */}
          <div className={styles.authInput}>
            <PhoneIcon height={20} alt="phone icon" className={styles.authIcon} />
            <input
              type="tel"
              name="phoneNumber"
          ...
          {/* Password */}
          <div className={styles.authInput}>
            <PasswordIcon height={20} alt="password icon" className={styles.authIcon} />
            <input
            ...
            >
              {showPassword ? <HidePasswordIcon height={20} alt="hide password icon" className={styles.authIcon} /> : <ShowPasswordIcon height={20} alt="show password icon" className={styles.authIcon} />}
            </button>
          </div>
          ...
          <div className={styles.authInput}>
            ...
            >
              {showConfirmPassword ? <HidePasswordIcon height={20} alt="hide password icon" className={styles.authIcon} /> : <ShowPasswordIcon height={20} alt="show password icon" className={styles.authIcon} />}
            </button>
          </div>
